...
void MainWindow::OnShowMorphologicalSkeletonRestorationClicked()
{
    vtkSmartPointer<vtkPNGReader> src = vtkSmartPointer<vtkPNGReader>::New();
    ...
    imageSkeleton->SetNumberOfIterations(15);
    imageSkeleton->ReleaseDataFlagOff();
